      ...
      <article className="mx-auto max-w-3xl px-6 pb-24 pt-28">
        ...
        <div className="mt-10 rounded-4xl bg-sand/60 p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted">
            ...
            <br />이 설정은 이 브라우저에만 저장되며, 다음 페이지부터 적용됩니다.
          </p>
          <div className="mt-5">
            <PrivacyOptOut />
          </div>
        ...
        <Section title="1. What is collected">
          ...
          <p className="mt-4">
            ...
            resume/CV download, e-mail, GitHub, LinkedIn, and project demo
            links — as the link type, not as anything about you.
          </p>
        </Section>
        ...
        <Section title="3. Why, and how long">
          <p>
            ...
            whether the site works on the devices people use — that is, to
            improve this portfolio. They are not sold, shared, or used to
            contact anyone. They are kept only as long as they are useful for
            that purpose, and are deleted on request.
          </p>
        </Section>
        ...
        <Section title="6. Your choices">
          <p>
            Use the switch above to stop collection in this browser. Ad
            blockers, tracker blockers, and private-window browsing also stop
            it. To ask what is stored about a visit, or to have records deleted,
            e-mail{" "}
            <a
        ...
        {/* ── 한국어 ────────────────────────────────────────────── */}
        <hr className="mt-16 border-ink/10" />
        ...
        <Section title="6. 방문자의 선택권">
          <p>
            ...
            차단기나 시크릿 창을 사용하는 경우에도 수집되지 않습니다. 저장된
            내용 확인이나 삭제를 원하시면{" "}
            <a
              href={`mailto:${person.email}`}
              className="text-ink underline underline-offset-4"
    ...
    <ul className="mt-3 space-y-2">
      {items.map((it) => (
        <li key={it} className="flex gap-3">
          <span aria-hidden className="mt-[0.6em] h-1 w-1 shrink-0 rounded-full bg-ink/30" />
          <span>{it}</span>
        </li>
      ))}
    </ul>
