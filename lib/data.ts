...
export const about = {
  ...
  bio: [
    [
      { w: "Based", s: false }, { w: "in", s: false }, { w: "Seoul,", s: false },
      { w: "I'm", s: false }, { w: "an", s: false },
      { w: "AI", s: true }, { w: "&", s: true }, { w: "robotics", s: true }, { w: "educator", s: true },
      { w: "and", s: false },
      { w: "full-stack", s: true }, { w: "developer", s: true },
      { w: "who", s: false }, { w: "blends", s: false },
      { w: "engineering", s: true }, { w: "with", s: false }, { w: "education.", s: true },
      { w: "I've", s: false }, { w: "shipped", s: false },
      { w: "AI", s: true }, { w: "education", s: true }, { w: "tools", s: true },
      { w: "used", s: false }, { w: "live", s: false }, { w: "in", s: false }, { w: "a", s: false }, { w: "museum,", s: false },
      { w: "built", s: false },
      { w: "crop-diagnosis", s: true }, { w: "models,", s: true },
      { w: "and", s: false }, { w: "made", s: false }, { w: "a", s: false },
      { w: "companion", s: true }, { w: "care", s: true }, { w: "robot.", s: true },
    ],
    [
      { w: "I", s: false }, { w: "love", s: false }, { w: "turning", s: false }, { w: "complex", s: false }, { w: "ideas", s: false }, { w: "into", s: false },
      { w: "playful,", s: true }, { w: "hands-on", s: true }, { w: "experiences", s: true },
      { w: "that", s: false }, { w: "reach", s: false }, { w: "real", s: false }, { w: "people.", s: false },
    ],
    [
      { w: "Let's", s: false }, { w: "build", s: false },
      { w: "something", s: true }, { w: "worth", s: true }, { w: "learning", s: true }, { w: "from.", s: true },
    ],
  ] as BioWord[][],
  facts: [
